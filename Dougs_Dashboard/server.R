  ...
  output$mymap <- renderLeaflet(
    {
      ...
      query <- str_c("select colourv,geom,traveltype,start_time_utc,time_taken,length2d_km,kg_all_co2e from dougtracks.dougtracks_lines_emi_mv_simple2 where traveltype = 'Walk'")
